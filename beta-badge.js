(function () {
  ...
  logos.forEach(function(logo) {
    ...
    if (logo.textContent.trim() === 'NEXELIA') {
      ...
      logo.innerHTML = 'NEXELIA <span style="background:#FF6B35;color:#fff;font-size:' + fontSize + ';font-weight:700;border-radius:50%;margin-left:8px;vertical-align:middle;display:inline-flex;align-items:center;justify-content:center;width:' + size + ';height:' + size + '">β</span>';
    }
  });
})();
